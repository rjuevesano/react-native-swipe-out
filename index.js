...
var SwipeoutBtn = (0, _createReactClass2.default)({
  ...
  render: function render() {
    ...
    if (btn.type === 'delete')
      styleSwipeoutBtn.push(_styles2.default.colorDelete);
    else if (btn.type === 'primary')
      styleSwipeoutBtn.push(_styles2.default.colorPrimary);
  ...
  _handlePanResponderGrant: function _handlePanResponderGrant(e, gestureState) {
    ...
    this.refs.swipeoutContent.measure(function(ox, oy, width, height) {
      ...
      _this2.setState({
        ...
        btnsLeftWidth: _this2.props.left
          ? buttonWidth * _this2.props.left.length
          : 0,
        btnsRightWidth: _this2.props.right
          ? buttonWidth * _this2.props.right.length
          : 0,
        swiping: true,
      ...
      _this3.setState(
        {
          ...
          btnsRightWidth: _this3.props.right
            ? btnWidth * _this3.props.right.length
            : 0,
        },
        function() {
  ...
  _openLeft: function _openLeft() {
    ...
    this.refs.swipeoutContent.measure(function(ox, oy, width, height) {
      ...
      _this4.setState(
        {
          btnWidth: btnWidth,
          btnsLeftWidth: _this4.props.left
            ? btnWidth * _this4.props.left.length
            : 0,
        },
        function() {
